...
const Login = () => {
    ...
    return <div className="relative max-w-screen min-h-screen flex items-center justify-center bg-gradient-to-tl from-[#e0ebfe] to-[#f2f4f5]">
        <div className="w-120 space-y-8 p-4 xl:p-6 border border-slate-400 rounded-xl">
            <div className="flex gap-x-2">
                <h2 className="font-semibold text-2xl text-dark-mode">Đăng Nhập</h2>
            </div>
            <form onSubmit={handleSubmit} className="flex flex-col gap-y-4 *:w-full">
                ...
                <div className="flex gap-x-2 italic text-sm justify-end">
                    <p>Bạn chưa có tài khoản?</p> <Link className="underline text-btn" to="/signup">Đăng ký ngay</Link>
                </div>
            </form>
